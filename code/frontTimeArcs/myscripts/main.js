var datasetName = "synthetic.tsv"
//var datasetName = "thiers_2012.tsv"
...
if (datasetName == "synthetic.tsv") {
    var minYear = 0;
    var maxYear = 12;
}

if (datasetName == "thiers_2012.tsv") {
    var minYear = 0;
    var maxYear = 2026;
}
...
d3.tsv("data/" + datasetName, function(error, data_) {
  ...
  csvContent += "CardId\tTime\tColor\tLabel\tEvidence\tEdge\n"
            ...
            for (var i=0; i<list.length;i++){
                ...
                for (var j=0; j<list.length;j++){
                  ...
                  //      rrr[term1+"__"+term2][year] = {};
                        ...
                        ttt[term1+"__"+term2][year].push(d["Color"]);
                    }    
                    else{
            ...
            if (year==l.m){
                ...
                for (var i=0; i<list.length;i++){
                    if (term1==list[i]){
                        for (var j=0; j<list.length;j++){
                            if (term2==list[j]){
                                if (!listBoth[d.Label.substring(0,10)+"**"+d.Color]){
                                    listCardId.push(d["CardId"]);
                                    listTilte.push(d.Label);
                                    listType.push(d.Color);
                                    listBoth[d.Label.substring(0,10)+"**"+d.Color] =1;
                                }
                            }    
                        }
                    }
